...
function initFormHandler() {
  ...
  formEl.addEventListener('submit',submitRecipe);
  ...
  var recipe_arr = getRecipesFromStorage();
  recipe_arr.push(recipeObject);
  ...
  const clear_l_storage = document.getElementsByClassName('danger')[0];
  clear_l_storage.addEventListener('click',clearFunc);
